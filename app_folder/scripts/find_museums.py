...
queries = [
    ...
    "art museums in Manhattan, New York",
    "art galleries in Manhattan, New York",
    "science museums in Manhattan, New York",
    "history museums in Manhattan, New York",
    "interactive museums in Manhattan, New York",
    "museums with exhibitions in Manhattan, New York",
    "contemporary art museums in Manhattan, New York",
]
...
df.write_csv(os.path.join(OUTPUT_FOLDER, "museums.csv"))

print(f"\nSaved {len(all_places)} museums to output_folder/museums.csv")
