...
queries = [
    "escape rooms in Manhattan, New York",
    "escape room experiences in Manhattan, New York",
    "puzzle rooms in Manhattan, New York",
    "immersive escape rooms in Manhattan, New York",
    "best escape rooms in Manhattan, New York",
    "team building escape rooms in Manhattan, New York",
]
...
df.write_csv(os.path.join(OUTPUT_FOLDER, "escape_rooms.csv"))

print(f"\nSaved {len(all_places)} escape rooms to output_folder/escape_rooms.csv")
