...
queries = [
    "board game cafe in Manhattan, New York",
    "board game lounges in Manhattan, New York",
    "tabletop game cafes in Manhattan, New York",
    "board game bars in Manhattan, New York",
    "game cafes in Manhattan, New York",
    "gaming lounges in Manhattan, New York",
]
...
df.write_csv(os.path.join(OUTPUT_FOLDER, "board_games.csv"))

print(f"\nSaved {len(all_places)} board game venues to output_folder/board_games.csv")
