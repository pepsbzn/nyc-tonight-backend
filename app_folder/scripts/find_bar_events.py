...
queries = [
    "trivia night bars in Manhattan, New York",
    "karaoke bars in Manhattan, New York",
    "bars with live DJ in Manhattan, New York",
    "cocktail lounges with events in Manhattan, New York",
    "bars with weekly events in Manhattan, New York",
    "game night bars in Manhattan, New York",
    "themed bars in Manhattan, New York",
    "speakeasy bars with events in Manhattan, New York",
]
...
df.write_csv(os.path.join(OUTPUT_FOLDER, "bar_events.csv"))

print(f"\nSaved {len(all_places)} bar event venues to output_folder/bar_events.csv")
