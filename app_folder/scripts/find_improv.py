...
queries = [
    "improv theater in Manhattan, New York",
    "improv comedy theaters in Manhattan, New York",
    "comedy theaters in Manhattan, New York",
    "sketch comedy theaters in Manhattan, New York",
    "improv shows in Manhattan, New York",
    "live comedy theater in Manhattan, New York",
]
...
df.write_csv(os.path.join(OUTPUT_FOLDER, "improv.csv"))

print(f"\nSaved {len(all_places)} improv venues to output_folder/improv.csv")
