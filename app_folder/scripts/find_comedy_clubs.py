...
queries = [
    "comedy clubs in Manhattan, New York",
    "stand up comedy venues in Manhattan, New York",
    "comedy shows in Manhattan, New York",
    "comedy theater in Manhattan, New York",
    "improv comedy in Manhattan, New York",
    "open mic comedy in Manhattan, New York",
]
...
print(f"\nAfter filtering: {len(all_places)} clubs (min 100 ratings, top 100 by rating)")
...
df.write_csv(os.path.join(OUTPUT_FOLDER, "comedy_clubs.csv"))

print(f"\nSaved {len(all_places)} comedy clubs to output_folder/comedy_clubs.csv")
